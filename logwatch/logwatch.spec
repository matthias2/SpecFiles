...
BuildArch:	noarch
Source:		ftp://ftp.kaybee.org/pub/linux/logwatch-7.4.0.tar.gz
...
%doc %{_mandir}/man5/logwatch.conf.5*
%doc %{_mandir}/man5/ignore.conf.5*
%doc %{_mandir}/man5/override.conf.5*
%config(noreplace) %{_sysconfdir}/logwatch/conf/*.conf

%doc LICENSE README

%changelog
* Tue Mar 01 2011 Mike Tremaine <mgt@stellarcore.net> 7.4.0-1
- Point release for CVE-2011-1018 security flaw in samba service
