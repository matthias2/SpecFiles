...
# been defined yet.
%define http_header_more_directory %(%{__tar} -tf %{S:200} 2>/dev/null | head -1)
...
%changelog
* Thu Oct 13 2011 Matthew Joens <matthew at meez dot com> - 1.0.8-1
- Updated to version 1.0.8.
- Added 3rd party module ngx_headers_more module.
