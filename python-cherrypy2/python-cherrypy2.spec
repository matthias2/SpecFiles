...
Patch6:         python-cherrypy-2.3.0-EPIPE.patch
...
%changelog
* Fri Jul 20 2012 Toshio Kuratomi <toshio@fedoraproject.org> - 2.3.0-17
- Catch EPIPE's provoked by clients. (dcallagh)
  https://bugzilla.redhat.com/show_bug.cgi?id=795984 

* Sat Jan 14 2012 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 2.3.0-16
- Rebuilt for https://fedoraproject.org/wiki/Fedora_17_Mass_Rebuild

* Tue Feb 08 2011 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 2.3.0-15
- Rebuilt for https://fedoraproject.org/wiki/Fedora_15_Mass_Rebuild

* Mon Aug 02 2010 Martin Bacovsky <mbacovsk@redhat.com> - 2.3.0-14
- fixed hanging of test framework on failing tests (on python 2.7)

* Fri Jul 30 2010 Martin Bacovsky <mbacovsk@redhat.com> - 2.3.0-13
- fixed tests failing on python 2.7

* Wed Jul 21 2010 David Malcolm <dmalcolm@redhat.com> - 2.3.0-12
