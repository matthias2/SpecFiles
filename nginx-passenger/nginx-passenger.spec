...
Source103:  50x.html
Source104:  404.html
# File manually downloaded from github:
# https://github.com/agentzh/headers-more-nginx-module/tags
Source200:  headers-more-nginx-module-0.20.tar.gz

# removes -Werror in upstream build scripts.  -Werror conflicts with
# -D_FORTIFY_SOURCE=2 causing warnings to turn into errors.
Patch0:     nginx-auto-cc-gcc.patch

# Define the directory for a 3rd party module.
# We should define this at the beginning but the Source file hasn't
# been defined yet.
%define http_header_more_directory %(%{__tar} -tf %{S:200} | head -1)
...
./configure \
    ...
    --add-module="./%{http_header_more_directory}" \
    --with-http_mp4_module \
    --with-cc-opt="%{optflags} $(pcre-config --cflags)" \
    --with-cc-opt="%{optflags} $(pcre-config --cflags)"
# Doesn't work on nginx < 1.3.0
...
%changelog
* Thu Aug 18 2011 Matthew Jones <matthew@meez.com> - 1.0.5-1
- Updated to new 1.0.5
- Added the ruby passenger module
